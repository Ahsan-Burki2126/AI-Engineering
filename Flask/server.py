...
def index_explicit():
    ...
    res.status_code = 200
    return res # Added 'res' here so it actually returns the response
...
def name_search():
    ...
    for person in data:
        # Fixed: person["first_name"].lower() is a function call
        if query.lower() in person["first_name"].lower():
            return person, 200

    # Fixed: Moved this outside the 'for' loop so it only 
